...
export declare class CfnBackupPlan extends cdk.CfnResource implements cdk.IInspectable {
     ...
     */
    backupPlanTags?: cdk.IResolvable | Record<string, string>;
    /**
...
export declare class CfnBackupVault extends cdk.CfnResource implements cdk.IInspectable {
     ...
     */
    backupVaultTags?: cdk.IResolvable | Record<string, string>;
    /**
...
export declare class CfnFramework extends cdk.CfnResource implements cdk.IInspectable {
     ...
     */
    frameworkTags?: Array<cdk.CfnTag | cdk.IResolvable> | cdk.IResolvable;
    /**
     * @param scope Scope in which this resource is defined
     * @param id Construct identifier for this resource (unique in its scope)
     * @param props Resource properties
...
export declare class CfnReportPlan extends cdk.CfnResource implements cdk.IInspectable {
     ...
     */
    reportPlanTags?: Array<cdk.CfnTag | cdk.IResolvable> | cdk.IResolvable;
    /**
 ...
 */
export declare class CfnRestoreTestingPlan extends cdk.CfnResource implements cdk.IInspectable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
