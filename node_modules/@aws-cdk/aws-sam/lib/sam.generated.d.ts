...
export declare namespace CfnFunction {
    ...
    interface CognitoEventProperty {
         ...
         * @link https://github.com/aws/serverless-application-model/blob/master/versions/2016-10-31.md#cognito
         */
        readonly trigger: string[] | string | cdk.IResolvable;
        /**
